...
| 2026-09-23 10:56:07 | ajuste de geolocalizacion dentro del proyecto | visual | Se solicita ajustar la geolocalizacion del proyecto mediante IP y ubicacion del usuraio. | aceptada |
| 2026-09-23 18:59:11 | finalizando | visual studio | ahora revierte a lo que anteriormente salia un resumen de todo y luego venia el menu, pero ahora con los cambios desaparecio la idea es que se siga mostrando esta informacion en consola ordenado de igual manera algo como el menu | acetada y corregida |
| 2026-09-23 19:15:44 | cambios por obesrvaciones | visual | Si un usuraio solicita mostrar empleados y no es gerente o administrador es muestra igual los correos y no aparcen cifrados, realicemos esta accion | aceptada y corregida |
